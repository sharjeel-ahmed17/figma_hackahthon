  ...
  return (
    <>
     <Cta/>
      ...
      <footer className="text-gray-600 body-font bg-green-500 z-10">
        <div className="max-w-[1240px] px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col md:mt-10 mt-0">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
           <h3>SHOP.CO</h3>
            ...
            <div className="flex gap-3 md:justify-noraml justify-center items-center">
              <div className="size-[28px] rounded-full bg-white flex justify-center items-center">

              <Facebook size='14px' color="black"/>
              </div>
              <div className="size-[28px] rounded-full bg-white flex justify-center items-center">

              <Twitter size='14px' color="black"/>
              </div>
              <div className="size-[28px] rounded-full bg-white flex justify-center items-center">

              <Instagram size='14px' color="black"/>
              </div>
              <div className="size-[28px] rounded-full bg-white flex justify-center items-center">

              <Github size='14px' color="black"/>
              </div>
